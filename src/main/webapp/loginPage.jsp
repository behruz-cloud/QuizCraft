    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/loginServlet" method="post">
                <div class="mb-3">
                    <input type="text" class="form-control" name="phone" placeholder="Telefon raqam" required>
                </div>
                <div class="mb-3">
            ...
            <div class="text-center mt-3">
                <p>Ro'yxatdan o'tmaganmisiz ? <a href="/registerPage.jsp">Ro'yxatdan o'tish</a></p>
            </div>
        </div>
    </div>
</div>
